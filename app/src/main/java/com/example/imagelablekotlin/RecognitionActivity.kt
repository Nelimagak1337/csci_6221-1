...
class RecognitionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        galleryLauncher=registerForActivityResult(
            ...
            object :ActivityResultCallback<ActivityResult>{
                override fun onActivityResult(result:ActivityResult?) {
                    val data=result?.data
                    try {
                        inputImage= InputImage.fromFilePath(this@RecognitionActivity,data?.data)
        ...
        btnChoosePicture.setOnClickListener{
            ...
            val builder=AlertDialog.Builder(this@RecognitionActivity)
    ...
    private fun checkPermission(permission:String, requestCode:Int)
    {
        if (ContextCompat.checkSelfPermission(
            ...
            ActivityCompat.requestPermissions(this@RecognitionActivity, arrayOf(permission),requestCode)
        }
    }
...
//                    .show()
            ...
            if (grantResults.isNotEmpty() &&grantResults[0]==PackageManager.PERMISSION_GRANTED){
                ...
                Toast.makeText(this@RecognitionActivity,"Storage Permission Denied",Toast.LENGTH_SHORT)
                    .show()
            }
